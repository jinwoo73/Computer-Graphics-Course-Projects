...
void draw() {
  ...
  for (int i = 0; i<50;i ++) {
    for (int j = 0; j <50; j++) {
      beginShape();
      texture(sheep_texture);
      vertex(i*quadsize+50,j*quadsize+50,0,i/50.0,j/50.0);
      vertex((i+1)*quadsize+50,j*quadsize+50,0,(i+1)/50.0,j/50.0);
      vertex((i+1)*quadsize+50,(j+1)*quadsize+50,0,(i+1)/50.0,(j+1)/50.0);
      vertex(i*quadsize+50,(j+1)*quadsize+50,0,i/50.0,(j+1)/50.0);
      endShape();
    }
  }
  popMatrix();
  ...
  //    shader(square_shader);
  //    beginShape();
  //    vertex(60 + 48*i, 60+48*j, 100, 0, 0);
  //    vertex(60 +48*i, 98 + 48*j, 100, 1, 0);
  //    vertex(98 +48*i, 60+ 48*j, 100, 1, 1);
  //    vertex(98+48*i, 98+48*j, 100, 0, 1);
  //    endShape();
  //  }
  //}
  shader(square_shader);
